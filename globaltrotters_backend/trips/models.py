...
# ... existing models (Trip, TripStop, Activity) ...

class Expense(models.Model):
    trip = models.ForeignKey(Trip, on_delete=models.CASCADE, related_name="expenses")
    # stop is nullable because an expense might be for the whole trip (e.g., a multi-city flight)
    stop = models.ForeignKey(TripStop, on_delete=models.SET_NULL, null=True, blank=True, related_name="expenses")
    category = models.CharField(max_length=50)
